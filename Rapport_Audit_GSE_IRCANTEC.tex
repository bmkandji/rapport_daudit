...
\bottomrule
\endfoot
\rowcolor{nxlightblue} Inflation (CT~/~LT) & Vasicek 2 facteurs & cible COR + Cibles distributionnelles & Schéma exact V2F & R~/~MATLAB \\
Taux réels (CT~/~LT) & Vasicek 2 facteurs & MCO + Cibles distributionnelles & Schéma exact V2F & R~/~MATLAB \\
\rowcolor{nxlightblue} Courbe nominale (ZC) & Fisher + corrections de covariance & Param. hérités taux-inflation + primes de risque & Formules fermées V2F & MATLAB \\
Crédit (spread IG) & CIR & {\small Schéma d'Euler puis Initialisation par OLS puis max.\ de vraisemblance ($\chi^2$ décentré)}. & Schéma d'Euler, Alfonsi ou Diop selon pas, pas mensuel (Alfonsi) & MATLAB \\
\rowcolor{nxlightblue} Dette privée (spread) & Black-Karasinski & Régression (log-spreads) & Schéma exact log-OU & MATLAB \\
Prime de liquidité & Écart CDS~/~obligataire ; ajust.\ de $\theta$ & Dire d'expert + Solveur d'implicitaion & --- & Excel~/~MATLAB \\
...
Action non cotée (PE) & BS (après \emph{unsmoothing}) & \emph{Unsmoothing} AR(1) + formule fermée & Loi normal iid & Excel~/~MATLAB \\
\rowcolor{nxlightblue} Immobilier & BS (après \emph{unsmoothing}) & \emph{Unsmoothing} AR(1) + formule fermée & Loi normal iid & Excel~/~MATLAB \\
Infrastructure & BS & Formule fermée & Loi normal iid & Excel~/~MATLAB \\
\rowcolor{nxlightblue} Corrélations & Gaussienne ; passage cibles $\to$ browniens & Pearson + formules de passage & Cholesky & Python \\
...
\toprule
\textbf{Classe d'actifs} & \textbf{2018} & \textbf{2021} & \textbf{2022} & \textbf{2023} & \textbf{2024} & \textbf{2025} \\
\midrule
Actions & 34,24\% & 42,71\% & 41,41\% & 40,76\% & 39,28\% & 45,77\% \\
Obligations d'entreprises (crédit) & 19,98\% & 24,39\% & 21,89\% & 23,19\% & 23,51\% & 18,40\% \\
Obligations souveraines nominales & 21,56\% & 6,78\% & 10,67\% & 11,15\% & 11,64\% & 9,74\% \\
Obligations souveraines indexées (inflation) & 16,25\% & 18,61\% & 16,57\% & 16,49\% & 17,66\% & 18,49\% \\
Immobilier (OPCI/OPPCI) & 6,33\% & 5,09\% & 6,26\% & 5,67\% & 5,34\% & 5,18\% \\
Investissements d'impacts/Non côtés & 1,63\% & 2,43\% & 3,20\% & 2,74\% & 2,57\% & 2,43\% \\
\midrule
\textbf{Total (M€)} & \textbf{11 016,30} & \textbf{14 816,33} & \textbf{13 334,66} & \textbf{15 471,31} & \textbf{17 185,00} & \textbf{18 571,73} \\
\bottomrule
\end{tabular}%
}
\end{table}
